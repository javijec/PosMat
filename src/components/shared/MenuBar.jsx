...
const MenuBar = ({ editor }) => {
  ...
  const baseClasses = "p-2 hover:bg-gray-100 transition-colors text-gray-600";
  const activeClasses = "bg-gray-200 text-indigo-600 font-bold";
  ...
  return (
    <div className="border-b border-gray-300 flex flex-wrap gap-1 p-1 bg-gray-50/50">
      <button
        type="button"
