    ...
    <div
      className={`overflow-hidden rounded-xl border bg-white shadow-sm transition-all duration-200 ${
        isOpen
          ...
          : "border-slate-200 hover:border-ingenieria/40 hover:shadow-md"
      }`}
    >
      <button
        type="button"
      ...
      >
        ...
        <span className="flex-1 text-base font-semibold leading-6 text-slate-900 sm:text-lg">{question}</span>
        <ChevronDownIcon
      ...
      {isOpen && (
        <div className="border-t border-slate-100 bg-slate-50/70 px-5 py-5 sm:px-6">
          <div
            className="prose prose-slate max-w-none leading-7 text-slate-600 prose-a:text-ingenieria"
