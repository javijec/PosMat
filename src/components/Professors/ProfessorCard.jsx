...
const ProfessorCard = ({ professor }) => {
  ...
  return (
    <article className="flex gap-4 rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-5 shadow-sm transition-shadow hover:shadow-md">
      ...
      <div className="min-w-0">
        <h2 className="text-lg font-bold text-[var(--text-main)]">{fullName || "Profesor/a"}</h2>
