...
const StudentCard = ({ student }) => {
  ...
  return (
    <article className="flex h-full min-h-[24rem] flex-col rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
