...
const Features = () => {
  return (
    <div className="py-8 sm:py-10 md:py-12 bg-[var(--bg-surface)] transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5 auto-rows-fr">
